...
export const Footer = () => {
  return (
    <div className="w-full bg-gray-900 text-white text-lg mt-auto py-6 px-4">
      <Container>
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul>
              <FooterLink to="http://localhost:5173/">
                Interview Preparation
              </FooterLink>              
              <FooterLink to="https://www.canva.com/resumes/templates/">
                Resume Building
              </FooterLink>
            </ul>
          </div>
